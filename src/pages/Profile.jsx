        ...
        <>
            ...
            <div className="flex justify-center py-10 px-4">
                <div className="flex flex-col gap-8 md:w-1/2">
                    ...
                    <div className="md:border-2 border-gray-300 rounded-lg md:py-6">
                        <div className="flex items-center justify-between md:px-8 pb-4 border-b-2 last:border-0 last:pb-0 mb-4 last:mb-0">
                            <div className="">
                        ...
                        <div className="flex items-center justify-between md:px-8 md:pb-4 min-[300px]:py-6 md:py-0 border-b-2 last:border-0 last:pb-0 mb-4 last:mb-0">
                            <div className="w-4/12">
